...
uint32_t precValue = 0;
uint32_t diff = 0;

void affichage_led(void){
	//Refresh
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	uint8_t data[] = {72, 101, 108, 108, 110, 13, 10};
	sprintf(MSG, "Ticks = %d\n\r", diff);
	HAL_UART_Transmit(&huart2, MSG, sizeof(MSG), 3000);
	HAL_Delay(100);
